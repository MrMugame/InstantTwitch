...
<div class="flex flex-col p-2">
    <div class="flex justify-between mb-5">
        <svg on:click={_ => page.set("streams")} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover: stroke-lighttext hover:stroke-strongtext" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
