...
<div class="flex justify-between items-center w-full border-b-[1px] h-10 p-1 border-lightborder dark:bg-foreground bg-lightforeground relative">
    <div class="flex flex-row h-full items-center">
        <input bind:value={$filter} type="text" placeholder="Search" class="dark:bg-background bg-lightbackground h-full w-48 rounded-full pl-2 dark:text-strongtext text-lightstrongtext mr-2 text-sm">
